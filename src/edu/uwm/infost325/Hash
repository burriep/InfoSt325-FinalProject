...
public class HashFunction {
	...
	public static void main(String[] args){
		Hashfunction a = newHashFunction(30)
		String[] ElemAddtery = {"1", "5", "17", "21", "26"};
		String[] ElemAddtery2 = {"100", "510", "170", "214", "268", "398", "235", "802", "900", "723", "699", "1", "16", "999", "890",
				"725", "998", "978", "988", "990", "889", "984", "320", "321", "400", "415", "450", "50", "660", "624"};
	...
	public void hashFunctionC(String[] input1, Sting[] arr1){
	...
	public void hashFunctionC(String[] input1, Sting[] arr1){
		...
		for (int i = 0; i < input1.length; i++){
			...
			++arrIndex;
			System.out.println("Try This " + arraIndex + " instead");
